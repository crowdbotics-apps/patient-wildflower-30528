...
## Project Structure
    ...
    ├── patient_wildflower_30528  # Django project configurations
...
1. Clone this repo and `cd patient_wildflower_30528`
...
2. Clone this repo and `cd patient_wildflower_30528`
